...
namespace B19_Ex03_Aviv_315529131_Gal_205431141
{
    public abstract class Engine
    {
        ...
        public float PrecentCurrentEnergy
        {
            get
            {
                return 100 * (m_CurrentEnergy / m_MaxEnergy);
            }
        }
        ...
        {
            return string.Format("Max energy: {1}{0}" + "Remaining energy percent: {2}%{0}", Environment.NewLine, m_MaxEnergy, PrecentCurrentEnergy);
        }
    }
}
